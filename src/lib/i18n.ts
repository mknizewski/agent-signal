...
const translations = {
  pl: {
    ...
    row: {
      ...
      dragToGroup: "Przeciągnij czat do innej grupy",
      groupMenuTitle: "Przypisanie do grupy",
      automatic: "Automatycznie",
      detectedGroup: (name: string) => `Wykryta grupa: ${name}`,
      noGroup: "Bez grupy",
      noGroupDescription: "Przenieś do sekcji „Brak projektu”",
  ...
  en: {
    ...
    row: {
      ...
      dragToGroup: "Drag chat to another group",
      groupMenuTitle: "Group assignment",
      automatic: "Automatic",
      detectedGroup: (name: string) => `Detected group: ${name}`,
      noGroup: "No group",
      noGroupDescription: "Move to the “No project” section",
